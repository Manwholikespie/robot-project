...
# load the csv file with the marble data
df = pd.read_csv('combinedData.csv')

# in order for KNeighborsClassifier to interpret our labels,
# a large blue marble needs to be "5", not "large blue marble".
